...
const routerAdapter = require('../adapters/express-route-adapters')
...
const AtualizaUsuariosController = require('../controllers/editar-usuario')
/**
 * @swagger
 * components:
 *   schemas:
...
router.get('/users', routerAdapter(new ListarUsuarioController()));
...
router.put('/users/:id', routerAdapter(new AtualizaUsuariosController()))
