...
import CriaEnderecoController from "../controllers/endereco/criar-endereco";
import EditarEnderecoController from "../controllers/endereco/editar-endereco";
import ListarEnderecoController from "../controllers/endereco/listar-endereco";
import DeletarEnderecoController from "../controllers/endereco/deletar-endereco";
...
router.get('/enderecos{/:id}', adaptRoute(new ListarEnderecoController()));
